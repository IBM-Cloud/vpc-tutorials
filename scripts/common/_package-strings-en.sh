...
package_info_missing_msg1="This script cannot run without a valid package-info.json. Make sure you are running the script from the same directory where the package-info.json and other supporting files are located."
