...
VSI_ZONE1_NIC_IP=$(echo "$VSI_ZONE1" | jq -r '.primary_network_interface.primary_ip.0.address')
VSI_ZONE2_NIC_IP=$(echo "$VSI_ZONE2" | jq -r '.primary_network_interface.primary_ip.0.address')
